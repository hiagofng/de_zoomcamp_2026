...
BUCKET_NAME = "de-zoomcamp_bucket02_fhv"
client = storage.Client(project='project-c92681f2-4463-49ea-9cf')

#01.csv.gz
BASE_URL = f"https://github.com/DataTalksClub/nyc-tlc-data/releases/download/fhv/fhv_tripdata_"
YEAR = {2019}
